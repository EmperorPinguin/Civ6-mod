...
Policy cards are represented as capital-only buildings that consume policy-slot resources. When editing obsolete policy cards, keep these pieces aligned:
...
- Put longer contributor knowledge in `docs/` if the README starts getting crowded.
